...
save(dat3, file = file.path(path,"Output","DMP","DMP_10_per100000.rdata"))
...
save(datMA2, file = file.path(path,"Output","DMP","DMP_10_Glidandeper100000.rdata"))
...
save(datGRP2, file = file.path(path,"Output","DMP","DMP_10_3årsgrupperper100000.rdata"))
...
save(datGrpMin2, file = file.path(path,"Output","DMP","DMP_10_2grupperper100000.rdata"))
